...
const nav = ['Characters','Styles','References','Panel Generator','Gallery','Settings'];
const hrefs: Record<string,string> = { Characters: '/characters', Styles: '/styles', References: '/references', 'Panel Generator': '/generator', Gallery: '/gallery', Settings: '/settings' };
